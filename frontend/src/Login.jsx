...
//       // Check and adapt to backend response structure
...
//       <footer className="text-center text-muted py-3">
//         <p>&copy; {new Date().getFullYear()} X App. All rights reserved.</p>
//         <p>
...
// const API_ENDPOINT = 'https://pebsz.onrender.com/api'; // Update to match your server URL
